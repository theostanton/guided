...
exports.HeaderMenu = ({ items, pathname, Link, inverted }) => <semantic_ui_react_1.Container>
        <semantic_ui_react_1.Menu size="large" pointing secondary inverted={inverted}>
            <semantic_ui_react_1.Menu.Item as="a" className="mobile only" icon="sidebar" onClick={() => {
}}/>
