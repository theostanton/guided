...
export type CreateProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: ApolloReactCommon.MutationFunction<CreateMutation, CreateMutationVariables>
    } & TChildProps;
export function withCreate<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  CreateMutation,
  CreateMutationVariables,
  CreateProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, CreateMutation, CreateMutationVariables, CreateProps<TChildProps, TDataName>>(CreateDocument, {
      alias: 'create',
      ...operationOptions
    });
};
...
export type GetUsernameProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<GetUsernameQuery, GetUsernameQueryVariables>
    } & TChildProps;
export function withGetUsername<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  GetUsernameQuery,
  GetUsernameQueryVariables,
  GetUsernameProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, GetUsernameQuery, GetUsernameQueryVariables, GetUsernameProps<TChildProps, TDataName>>(GetUsernameDocument, {
      alias: 'getUsername',
      ...operationOptions
    });
};
