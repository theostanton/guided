 ...
 */
export type DefaultEffect = "coverflow" | "pile" | "cube" | "wheel"
 ...
 */
export type ViewPagerPageProps = Partial<{
  /**
 ...
 * @public
 */
export const Page = React.forwardRef<HTMLDivElement, ViewPagerPageProps>(
  (props, forwardedRef) => {
    const {
      currentPage = 0,
      gap = 20,
