...
var _a = require("graphile-utils"), makeExtendSchemaPlugin = _a.makeExtendSchemaPlugin, gql = _a.gql;
console.log("importing plugin?");
console.log(makeExtendSchemaPlugin);
var generator = function (build) {
    console.log("build");
    return {
        ...
        resolvers: {
            Mutation: {
                addSpotFromLatLng: function (_query, args, context, resolveInfo) { return __awaiter(void 0, void 0, void 0, function () {
                    var input;
